    ...
    try:
        ...
        if data == 'admin_show_remove_admins':
            ...
            if not removable_admins:
                ...
                return await event.edit("🗑 *Select Admin to Remove*", buttons=kb,
                                       link_preview=False)
        ...
        if data == 'admin_targets':
            ...
            kb.append([Button.inline("🔙 Back", b"admin_home")])
            return await event.edit("📺 *Manage Target Channels*", buttons=kb,
                                   link_preview=False)
        if data == 'admin_show_remove_targets':
            ...
            return await event.edit("🗑 *Select Target Channel to Remove*", buttons=kb,
                                   link_preview=False)
        ...
        if data == 'admin_sources':
            ...
            kb.append([Button.inline("🔙 Back", b"admin_home")])
            return await event.edit("📡 *Manage Source Channels*", buttons=kb,
                                   link_preview=False)
        if data == 'admin_show_remove_sources':
            ...
            return await event.edit("🗑 *Select Source Channel to Remove*", buttons=kb,
                                   link_preview=False)
...
async def channel_handler(event):
    ...
    try:
        ...
        logger.error(f"⚠ TTF bot error for contract {contract} (from message {message_id}): {e}", exc_info=True)
