...
def build_announcement_buttons(contract):
    return [
        [Button.url("📈 Chart", f"https://dexscreener.com/solana/{contract}"),
         Button.url("🛡 Trojan", "https://t.me/solana_trojanbot?start=r-gemwagmi")],  # Senin Trojan linkin
        [Button.url("🐉 Soul", "https://t.me/soul_sniper_bot?start=9FDbnU6TsKGX"),  # Senin Soul linkin
